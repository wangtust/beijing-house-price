...
model_totalPrice.fit(X_train, y_train_totalPrice, epochs=200, batch_size=32, validation_split=0.2)
...
model_price.fit(X_train, y_train_price, epochs=200, batch_size=32, validation_split=0.2)
